...
@Database(
    entities = [ CartEntity::class, UserEntity::class, SpecialItemEntity::class, SellingItemEntity::class, PaginationKeysEntity::class],
    version = 1,
)
abstract class ShoppingDataBase :RoomDatabase(){
    ...
    abstract fun paginationKeyDao():PagingKeyDao
